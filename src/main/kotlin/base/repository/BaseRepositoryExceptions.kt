...
object BaseRepositoryExceptions {
    ...
    fun funException(errorMethod: String, value: String? = "IllegalStateException") = BaseRepositoryException(value, errorMethod, "BR_001")
    ...
    fun funExceptionInsertVersion(errorMethod: String, value: String? = "1") = BaseRepositoryException("New entity field 'version' must be 0. Currene version: $value", errorMethod, "BR_004")
    fun funExceptionFindId(errorMethod: String, value: String? = "35323535") = BaseRepositoryException("Entity with id '$value' not found", errorMethod, "BR_005")
