...
object ModifierExceptions {
    ...
    fun funExceptionTier(errorMethod: String, value: String? = "") = ModifierException("Modifier tier level $value must be at least 1", errorMethod, "MD_005", listOf(value.orEmpty()))
