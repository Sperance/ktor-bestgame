...
data class PoeCapabilities(
    ...
    val apiRevision: Int = 4,
    val passiveTree: Boolean = true,
    ...
    val iconSet: String = ru.descend.domain.icons.IconRenderer.SET_ID,
    val iconSetRevision: Int = ru.descend.domain.icons.IconRenderer.SET_REVISION,
    val iconSetVersion: String = ru.descend.domain.icons.IconCatalog.version,
    val iconCount: Int = ru.descend.domain.icons.IconCatalog.icons.size,
    val iconsEndpoint: String = "/api/v1/icons",
