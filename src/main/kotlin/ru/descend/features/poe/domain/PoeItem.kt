...
@Serializable
@kotlinx.serialization.SerialName("features.poe.PoeRarity")
enum class PoeRarity { NORMAL, MAGIC, RARE, UNIQUE }

@Serializable
@kotlinx.serialization.SerialName("features.poe.PoeRoll")
...
@Serializable
@kotlinx.serialization.SerialName("features.poe.PoeItem")
data class PoeItem(
    val baseId: String,
    val itemLevel: Int,
...
@Serializable
@kotlinx.serialization.SerialName("features.poe.PoeCurrency")
