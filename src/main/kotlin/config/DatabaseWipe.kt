...
object DatabaseWipe {
    ...
    /** Метка последней очистки (0.56.0, формат 0.66.0, карта мира 0.67.0). Новая очистка - новая метка, старая просто остаётся в коллекции. */
    const val MARKER = "wipe-0.67.0"
