 ...
 * герои не знают умений и не носят фляг, а книги и эссенции - новые предметы справочника.
 */
object DatabaseWipe {
    ...
    /** Метка последней очистки (0.56.0, формат 0.66.0, карта мира 0.67.0, умения и фляги 0.69.0). Новая очистка - новая метка. */
    const val MARKER = "wipe-0.69.0"
