 ...
 */
const val SERVER_VERSION = "0.69.0"
 ...
 * только за Ваал-зоной: `corrupt` без `vaal` отвечает `CP_012` (0.57.0); 11 - карта мира: `world` вместо
 * `chapters`, зону проходит `boss`, выход - `leave` вместо `complete` (0.67.0); 12 - в `world` зоны без
 * пулов модификаторов, зона целиком - `zone` ответа `start` (0.68.1); 13 - мана, умения классов, фляги
 * и эссенции: `skills` и `essences` в `world.json`, маршруты умений `skills`, кристаллов `campaign/crystal` и `applyEssence` (0.69.0).
 */
